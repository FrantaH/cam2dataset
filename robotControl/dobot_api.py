...
# Port Feedback
# MyTypeNova5 = np.dtype([MyTypeMG400=np.dtype([
#     ('len', np.int64,),                 ('len', np.int16, ), 
# !    ('digital_input_bits', np.uint64,),                 ('Reserve', np.int16, (3,) ),
#     ('digital_output_bits', np.uint64,),                 ('digital_input_bits', np.int64, ), 
#     ('robot_mode', np.uint64,),                 ('digital_outputs', np.int64, ), 
#     ('time_stamp', np.uint64,),                 ('robot_mode', np.int64, ), 
#     ('time_stamp_reserve_bit', np.uint64,),                 ('controller_timer', np.int64, ),
#     ('test_value', np.uint64,),                 ('run_time', np.int64, ), 
#     ('test_value_keep_bit', np.float64,),                 ('test_value', np.int64, ), 
#     ('speed_scaling', np.float64,),                 ('safety_mode', np.float64, ), 
#     ('linear_momentum_norm', np.float64,),                ('speed_scaling', np.float64, ), 
#     ('v_main', np.float64,),                 ('linear_momentum_norm', np.float64, ),
#     ('v_robot', np.float64,),                 ('v_main', np.float64, ), 
#     ('i_robot', np.float64,),                ('v_robot', np.float64, ), 
#     ('i_robot_keep_bit1', np.float64,),                ('i_robot', np.float64, ), 
#     ('i_robot_keep_bit2', np.float64,),                ('program_state', np.float64, ), 
# !    ('tool_accelerometer_values', np.float64, (3, )),                ('safety_status', np.float64, ), 
#     ('elbow_position', np.float64, (3, )),                ('tool_accelerometer_values', np.float64, (3,)),
#     ('elbow_velocity', np.float64, (3, )),                ('elbow_position', np.float64, (3,)), 
# !    ('q_target', np.float64, (6, )),                ('elbow_velocity', np.float64, (3,)), 
#     ('qd_target', np.float64, (6, )),                ('q_target', np.float64, (6,)), 
#     ('qdd_target', np.float64, (6, )),                ('qd_target', np.float64,(6,)),
#     ('i_target', np.float64, (6, )),                ('qdd_target', np.float64, (6,)), 
#     ('m_target', np.float64, (6, )),                ('i_target', np.float64,(6,)), 
#     ('q_actual', np.float64, (6, )),                ('m_target', np.float64, (6,)), 
#     ('qd_actual', np.float64, (6, )),                ('q_actual', np.float64, (6,)), 
#     ('i_actual', np.float64, (6, )),                ('qd_actual', np.float64, (6,)), 
#     ('actual_TCP_force', np.float64, (6, )),                ('i_actual', np.float64, (6,)), 
#     ('tool_vector_actual', np.float64, (6, )),                ('i_control', np.float64, (6,)), 
#     ('TCP_speed_actual', np.float64, (6, )),                ('tool_vector_actual', np.float64, (6,)), 
#     ('TCP_force', np.float64, (6, )),                ('TCP_speed_actual', np.float64, (6,)), 
#     ('Tool_vector_target', np.float64, (6, )),                ('TCP_force', np.float64, (6,)),
#     ('TCP_speed_target', np.float64, (6, )),                ('Tool_vector_target', np.float64, (6,)), 
#     ('motor_temperatures', np.float64, (6, )),                ('TCP_speed_target', np.float64, (6,)), 
#     ('joint_modes', np.float64, (6, )),                ('motor_temperatures', np.float64, (6,)), 
#     ('v_actual', np.float64, (6, )),                ('joint_modes', np.float64, (6,)), 
# !    # ('dummy', np.float64, (9, 6))])                ('v_actual', np.float64, (6,)), 
#     ('hand_type', np.byte, (4, )),                ('handtype', np.int8, (4,)),
#     ('user', np.byte,),                ('userCoordinate', np.int8, ), 
#     ('tool', np.byte,),                ('toolCoordinate', np.int8, ),
#     ('run_queued_cmd', np.byte,),                ('isRunQueuedCmd', np.int8, ), 
#     ('pause_cmd_flag', np.byte,),                ('isPauseCmdFlag', np.int8, ),
#     ('velocity_ratio', np.byte,),                ('velocityRatio', np.int8, ), 
#     ('acceleration_ratio', np.byte,),                ('accelerationRatio', np.int8, ),
#     ('jerk_ratio', np.byte,),                ('jerkRatio', np.int8, ), 
#     ('xyz_velocity_ratio', np.byte,),                ('xyzVelocityRatio', np.int8, ),
#     ('r_velocity_ratio', np.byte,),                ('rVelocityRatio', np.int8, ), 
#     ('xyz_acceleration_ratio', np.byte,),                ('xyzAccelerationRatio', np.int8, ),
#     ('r_acceleration_ratio', np.byte,),                ('rAccelerationRatio', np.int8, ), 
#     ('xyz_jerk_ratio', np.byte,),                ('xyzJerkRatio', np.int8, ),
#     ('r_jerk_ratio', np.byte,),                ('rJerkRatio', np.int8, ), 
#     ('brake_status', np.byte,),                ('BrakeStatus', np.int8, ),
#     ('enable_status', np.byte,),                ('EnableStatus', np.int8, ),
#     ('drag_status', np.byte,),                ('DragStatus', np.int8, ),
#     ('running_status', np.byte,),                ('RunningStatus', np.int8, ),
#     ('error_status', np.byte,),                ('ErrorStatus', np.int8, ),
#     ('jog_status', np.byte,),                ('JogStatus', np.int8, ),
#     ('robot_type', np.byte,),                ('RobotType', np.int8, ),
#     ('drag_button_signal', np.byte,),                ('DragButtonSignal', np.int8, ),
#     ('enable_button_signal', np.byte,),                ('EnableButtonSignal', np.int8, ),
#     ('record_button_signal', np.byte,),                ('RecordButtonSignal', np.int8, ),
#     ('reappear_button_signal', np.byte,),                ('ReappearButtonSignal', np.int8, ),
#     ('jaw_button_signal', np.byte,),                ('JawButtonSignal', np.int8, ),
#     ('six_force_online', np.byte,),                ('SixForceOnline', np.int8, ),#1037
#     ('reserve2', np.byte, (82, )),                ('Reserve2', np.int8, (82,)),
#     ('m_actual', np.float64, (6, )),                ('m_actual[6]', np.float64, (6,)), 
#     ('load', np.float64,),                ('load', np.float64, ),
#     ('center_x', np.float64,),                ('centerX', np.float64, ), 
#     ('center_y', np.float64,),                ('centerY', np.float64, ),
#     ('center_z', np.float64,),                ('centerZ', np.float64, ), 
#     ('user[6]', np.float64, (6, )),                ('user', np.float64, (6,)),
#     ('tool[6]', np.float64, (6, )),                ('tool', np.float64, (6,)), 
#     ('trace_index', np.float64,),                ('traceIndex', np.int64,),
#     ('six_force_value', np.float64, (6, )),                ('SixForceValue', np.int64, (6,)),
#     ('target_quaternion', np.float64, (4, )),                ('TargetQuaternion', np.float64, (4,)),
#     ('actual_quaternion', np.float64, (4, )),                ('ActualQuaternion', np.float64, (4,)),
#     ('reserve3', np.byte, (24, ))                ('Reserve3', np.int8, (24,)),
#     ])                ])


# Port Feedback
MyTypeMG400=np.dtype([
    ('len', np.int16, ), 
    ('Reserve', np.int16, (3,) ),
    ...
    ('handtype', np.int8, (4,)),
    ('userCoordinate', np.int8, ), 
    ('toolCoordinate', np.int8, ),
    ('isRunQueuedCmd', np.int8, ), 
    ('isPauseCmdFlag', np.int8, ),
    ('velocityRatio', np.int8, ), 
    ('accelerationRatio', np.int8, ),
    ('jerkRatio', np.int8, ), 
    ('xyzVelocityRatio', np.int8, ),
    ('rVelocityRatio', np.int8, ), 
    ('xyzAccelerationRatio', np.int8, ),
    ('rAccelerationRatio', np.int8, ), 
    ('xyzJerkRatio', np.int8, ),
    ('rJerkRatio', np.int8, ), 
    ('BrakeStatus', np.int8, ),
    ('EnableStatus', np.int8, ),
    ('DragStatus', np.int8, ),
    ('RunningStatus', np.int8, ),
    ('ErrorStatus', np.int8, ),
    ('JogStatus', np.int8, ),
    ('RobotType', np.int8, ),
    ('DragButtonSignal', np.int8, ),
    ('EnableButtonSignal', np.int8, ),
    ('RecordButtonSignal', np.int8, ),
    ('ReappearButtonSignal', np.int8, ),
    ('JawButtonSignal', np.int8, ),
    ('SixForceOnline', np.int8, ),#1037
    ('Reserve2', np.int8, (82,)),
...
class DobotApi:
    ...
    def send_data(self, string):
        try:
            self.log(f"Sent:\t\t{string}\t port:{self.port}")
    ...
    def wait_reply(self):
        ...
        try:
            ...
            if len(data) == 0:
                ...
                self.log(f'Received:\t{data_str}\t port:{self.port}')
            return data_str 
...
class DobotApiMove(DobotApi):
    ...
    def RelJointMovJ(self, offset1, offset2, offset3, offset4, *dynParams):
        """
        The relative motion command is carried out along the joint coordinate system of each axis,
          and the end motion mode is joint motion
        Offset motion interface (point-to-point motion mode)
        j1~j6:Point position values on each joint
